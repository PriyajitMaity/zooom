...
const MeetingCard = ({
  ...
  return (
    <section className="flex min-h-[258px] w-full flex-col justify-between rounded-[14px] bg-[#1C1F2E] px-5 py-8 xl:max-w-[568px]">
      ...
      <article className={cn("flex flex-col gap-4 justify-center relative", {})}>
        ...
        {!isPreviousMeeting && (
          <div className="flex justify-center gap-8">
            <Button onClick={handleClick} className="rounded bg-[#0E78F9] cursor-pointer hover:bg-[#0E78F9] px-6">
              {buttonIcon1 && (
